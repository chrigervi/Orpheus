...
namespace orpheus
{
	class AudioStreamHostConnection : public AudioStreamConnection
	{
	public:
		AudioStreamHostConnection(float sample_rate, size_t max_audio_buffer_size = ORPHEUS_AUDIOSTREAM_BSIZE);
